...
El 100% de los **19 casos de integración implementados** cuentan con el siguiente stack de resiliencia (el único [caso planificado (19)](../PLANNED_CASES.md) deberá incorporarlo en su implementación futura):
