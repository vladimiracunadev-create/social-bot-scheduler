...
El **HUB** es la herramienta maestra para gestionar la matriz de 12 casos implementados (los [8 casos planificados](../PLANNED_CASES.md) aún no son operables desde el HUB):
