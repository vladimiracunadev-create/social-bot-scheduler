...
El **HUB** es la herramienta maestra para gestionar la matriz de 15 casos implementados (los [5 casos planificados](../PLANNED_CASES.md) aún no son operables desde el HUB):
