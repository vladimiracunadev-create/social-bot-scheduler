...
El **HUB** es la herramienta maestra para gestionar la matriz de 17 casos implementados (los [3 casos planificados](../PLANNED_CASES.md) aún no son operables desde el HUB):
