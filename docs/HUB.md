...
1. **HUB CLI** (`hub.py` / `hub.sh` / `hub.ps1`) — la herramienta para gestionar la matriz de **15 casos implementados** (+ [5 planificados](PLANNED_CASES.md)) desde terminal de forma centralizada, segura y estandarizada.
