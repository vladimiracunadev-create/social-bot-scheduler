...
1. **HUB CLI** (`hub.py` / `hub.sh` / `hub.ps1`) — la herramienta para gestionar la matriz de **12 casos implementados** (+ [8 planificados](PLANNED_CASES.md)) desde terminal de forma centralizada, segura y estandarizada.
