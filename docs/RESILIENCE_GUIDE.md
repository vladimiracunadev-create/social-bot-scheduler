...
|-----------|-------------|--------|
| **Reintentos Autom?ticos** | 3 intentos con 1s de espera | ? 19/19 casos |
| **Dead Letter Queue** | Registro de errores irrecuperables | ? 19/19 casos |
| **Idempotencia** | Prevenci?n de duplicados | ? 19/19 casos |
| **Circuit Breaker** | Protecci?n contra servicios ca?dos | ? 19/19 casos |
