...
Activa la matriz completa de 9 casos implementados y el stack de observabilidad. (Los [11 casos planificados](PLANNED_CASES.md) no se levantan: solo existen como scaffolding documental.)
```bash
