...
Activa la matriz completa de 17 casos implementados y el stack de observabilidad. (Los [3 casos planificados](PLANNED_CASES.md) no se levantan: solo existen como scaffolding documental.)
```bash
