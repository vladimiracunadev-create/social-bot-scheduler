...
class Post(BaseModel):
    ...
    channels: List[str] = Field(default_factory=list, description="Lista de canales de destino")
    scheduled_at: datetime = Field(..., description="Fecha y hora programada para la publicación")
