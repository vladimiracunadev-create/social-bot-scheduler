...
Para cada uno de los **12 casos de integración implementados**, debes realizar el siguiente proceso (los [8 casos planificados](docs/PLANNED_CASES.md) aún no tienen workflows que importar):
