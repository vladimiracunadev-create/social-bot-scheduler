...
Para cada uno de los **19 casos de integración implementados**, debes realizar el siguiente proceso (el [caso 19, planificado](docs/PLANNED_CASES.md), aún no tiene workflow que importar):
