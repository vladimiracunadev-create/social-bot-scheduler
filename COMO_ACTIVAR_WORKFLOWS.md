...
Para cada uno de los **17 casos de integración implementados**, debes realizar el siguiente proceso (los [3 casos planificados](docs/PLANNED_CASES.md) aún no tienen workflows que importar):
