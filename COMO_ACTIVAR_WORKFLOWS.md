...
Para cada uno de los **19 casos de integración implementados**, debes realizar el siguiente proceso (el [1 caso planificado](docs/PLANNED_CASES.md) aún no tienen workflows que importar):
