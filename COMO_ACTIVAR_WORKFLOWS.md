...
Para cada uno de los **15 casos de integración implementados**, debes realizar el siguiente proceso (los [5 casos planificados](docs/PLANNED_CASES.md) aún no tienen workflows que importar):
